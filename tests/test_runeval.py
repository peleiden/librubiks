...
class TestRuneval(MainTest):
	...
	def test_run(self):
		...
		expected_files = ['evaluation_results', 'eval_sollengths.png', 'eval_winrates.png', 'time_winrate.png',
		                  'states_winrate.png', 'eval_settings.json']  # Some files are excluded, as they only appear if enough cubes are solved
